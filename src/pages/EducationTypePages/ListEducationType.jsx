...
import {
    GetEducationTypeApi,
    CreateEducationTypeApi,
    UpdateEducationTypeApi,
    DeleteEducationTypeApi
} from "../../Api/EducationTypeApi.jsx";
...
function ListEducationType() {
    ...
    const createMutation = useMutation({
        mutationKey: ["create-education-type"],
        mutationFn: CreateEducationTypeApi,
        onSuccess: (data) => {
    ...
    const updateMutation = useMutation({
        mutationKey: ["update-education-type"],
        mutationFn: UpdateEducationTypeApi,
        onSuccess: (data) => {
    ...
    const deleteMutation = useMutation({
        mutationKey: ["delete-education-type"],
        mutationFn: DeleteEducationTypeApi,
        onSuccess: () => {
